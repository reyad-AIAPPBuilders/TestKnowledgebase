"""
POST /api/v1/discover — Scan file sources, read permissions, compute hashes, return what changed.
"""

from fastapi import APIRouter, Request

from app.models.common import ErrorCode, NtfsACL, ResponseEnvelope
from app.models.discover import DiscoverData, DiscoverRequest, FileInfo
from app.services.discovery.discovery_service import DiscoveryError
from app.utils.logger import get_logger

log = get_logger(__name__)

router = APIRouter(prefix="/api/v1", tags=["File Discovery"])
